        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <ul class="nav">
              ...
              <li class="scroll-to-section"><a href="#contact">Contact Now</a></li>  
                @if (Route::has('login'))
                        @auth
                    ...
                    <div class="row">
                        <div class="col-lg-6 align-self-center">
                            <div class="left-content header-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1s">
                                <h6>Gérez vos déchets électroniques</h6>
                                <h2>Recyclez <em>Responsable</em></h2>
                                <p>Solution moderne, respectueuse de l'environnement.</p>
                                <form id="search" action="#" method="GET">
                                    <fieldset>
                                        <input type="address" name="address" class="email" placeholder="Votre site web..." autocomplete="on" required>
                                    </fieldset>
                                    <fieldset>
                                        <button type="submit" class="main-button">Analyser</button>
                                    </fieldset>
                                </form>
                            </div>
                        </div>
